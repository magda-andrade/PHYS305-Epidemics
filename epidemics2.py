...
from scipy import integrate#this module helps with integration
func = lambda y: (abs(y-1))/abs(y)   #assign function
okay =integrate.romberg(func,0.001,1.,show = True)# throws out the romberg integrations
print(okay)#prints result
